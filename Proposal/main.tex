...
\twocolumn[
\icmltitle{Sample RL Project Proposal}
...
\icmlauthor{Dimitris Diochnos}{} %{equal,yyy}
\icmlauthor{Anna Partner}{} %{equal,yyy,comp}
...
%\cnote{State whether you want to do a long or short project on RL.  The big difference is the depth.}  We propose a long RL project.
